  ...
  const handleAddToCart = () => {
    ...
    if (existingItemIndex > -1) {
      ...
      cart.push({
        ...
        color,
        quantity,
        image: product.image  // Ensure we're adding the image to the cart item
      })
    }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <button 
            ...
            className="w-full bg-myPink hover:bg-myPink/70 text-white font-bold py-2 px-4 rounded"
          >
            Add to Cart
          </button>
        </div>
